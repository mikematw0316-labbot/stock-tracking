...
### 🧩 照片拼貼（Facebook 最佳化）
- 14 款版型（FB 相簿五格、封面三聯、雜誌風、馬賽克、電影感、拍立得留白…）
- FB 用途預設，匯出即為官方建議像素：
  貼文 1080×1080／直式 1080×1350／限動 1080×1920／封面 851×315／連結分享圖 1200×630
- 間距、圓角、背景色票即時調整
- 點格子上傳、拖曳構圖、雙指捏合縮放、批次上傳
- 手機匯出直接開啟**系統分享面板**（一鍵傳 Facebook App），桌機自動下載 PNG
- **無縫輪播**：長畫布自動裁成 2~5 張，發 FB 多圖貼文滑動時圖案無縫接續
  （2 張免費；3 張以上 Premium）
- 免費版含浮水印，Premium 無浮水印
